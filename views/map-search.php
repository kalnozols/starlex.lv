...
<section class="map-search">
   ...
   <script>
      ...
      function initMap() {
          ...
          // definē info logus
          var infowindow = new google.maps.InfoWindow({ content: '<?php require ('././blocks/gmap-estate-info.php'); ?>' });
          var groupinfowindow = new google.maps.InfoWindow({ content: '<?php require ('././blocks/gmap-estate-group-info.php'); ?>' }); 
